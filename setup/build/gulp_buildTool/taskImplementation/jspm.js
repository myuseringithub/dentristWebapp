...
module.exports = async ()=> {
	...
	var process = childProcess.execSync('n stable; jspm install; n v8.0.0-nightly20170126a67a04d765', { cwd: destination('clientSide/jspm_packages_modules/'), shell: true, stdio:[0,1,2] });
